...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[30, 60, 90, 120, 150, 180, 200, 220, 240, 260, 280], gamma=0.5)
...
for epoch in range(300):
    ...
    torch.save(net.state_dict(), os.path.join(args.checkpoint_dir, "extra_classifier_epoch" + str(epoch+1) + ".pth"))
    print("Saved intermediate checkpoint to extra_classifier_epoch{epoch+1}.pth")
