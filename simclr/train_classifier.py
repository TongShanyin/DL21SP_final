...
for epoch in range(70):
    ...
    if epoch % 10 == 9: # save every 10 epochs
        ...
        torch.save(net.state_dict(), os.path.join(args.checkpoint_dir, "classifier_"+args.encoder_checkpoint[12:-4]+f"_epoch{epoch+1}.pth"))
        print("Saved intermediate checkpoint to classifier_"+args.encoder_checkpoint[12:-4]+f"_epoch{epoch+1}.pth")
