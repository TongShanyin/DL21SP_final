...
for epoch in range(30):
    ...
    if epoch % 10 == 9: # save every 10 epochs
        ...
        torch.save(net.state_dict(), os.path.join(args.checkpoint_dir, "classifier"+args.encoder_checkpoint[-2:]+f"_epoch{epoch+1}.pth"))
...
print(f"Saved checkpoint to {os.path.join(args.checkpoint_dir, 'classifier.pth')}")
